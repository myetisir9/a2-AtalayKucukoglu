...
<body style="background-color: beige"> 
    ...
    <section>
        ...
        <h1 class="h1"><img class="logo-left" src="/static/inkscape/logo.png" alt="logo">Traditional Turkish Desserts<img class="logo-right" src="inkscape/logo.png" alt="logo"></h1>
